...
namespace Cinturon360.Shared.Models.Kernel.Transactions;
...
public class Transaction
{
    ...
    [Required]
    [StringLength(14)]
    public required string InvoiceID { get; set; } = Nanoid.Generate(alphabet: Nanoid.Alphabets.HexadecimalUppercase, size: 14);
