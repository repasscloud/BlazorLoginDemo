...
namespace Cinturon360.Shared.Models.Kernel.SysVar
{
    ...
    public class C360SystemLog
    {
        ...
        // Level / codes
        public SysLogLevel Level { get; set; } = SysLogLevel.Information;

        public SysLogEvtType Evt { get; set; } = SysLogEvtType.GENERIC;            // e.g. API_REQ_END, UI_ACTION

        public SysLogCatType Cat { get; set; }          // category enum
        public SysLogActionType Act { get; set; }       // action enum
        public SysLogOutcome Out { get; set; } = SysLogOutcome.OK;
