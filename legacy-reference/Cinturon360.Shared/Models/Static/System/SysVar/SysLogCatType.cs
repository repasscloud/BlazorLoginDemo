...
public enum SysLogCatType : int
{
    ...
    // 200–299 Travel domain (core product flows)
    Travel          = 200, // umbrella for travel domain
    Shopping        = 210, // search/offers (flight/hotel/car), repricing inputs
    //Quoting         = 220, // quote lifecycle (if you want domain-level separate from commercial)
    Booking         = 230, // booking lifecycle (create/confirm/change/cancel)
    Ticketing       = 240, // issue/void/refund/reissue
    Itinerary       = 250, // itinerary build/render/delivery
    Policy          = 260, // travel policy evaluation outcomes (domain-side)
    Traveller       = 270, // traveller profile, documents, preferences
    SupplierContent = 280, // content sync/cache (airlines/hotels/cars)
