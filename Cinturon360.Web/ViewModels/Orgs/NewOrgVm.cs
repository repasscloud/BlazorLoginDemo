...
public sealed record NewOrgVm
{
    ...
    public TaxTypeReference TaxTypeRef { get; init; } = default!;
    public TimeZoneReference TimeZoneRef { get; init; } = default!;
    public CountryReference CountryRef { get; init; } = default!;  // we use the country list in this for org's location only
