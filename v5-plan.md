...
- Single Stripe account for the platform
- Per-org Stripe onboarding when enabled for Stripe payments
- Org accounts payable team gets a Stripe portal view (card on file, payments, invoices)
- Non-Stripe clients supported via a reconciliation workflow
